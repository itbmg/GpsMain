<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Routewise_locations.aspx.cs" Inherits="Routewise_locations" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <section class="content-header">
            <h1>
                Routewise Locations Report<small>Preview</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Tools</a></li>
                <li><a href="#">Routewise Locations Report</a></li>
            </ol>
        </section>
        <br />
        <section class="content">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <i style="padding-right: 5px;" class="fa fa-cog"></i>Routewise Locations Details
                    </h3>
                </div>
                <div class="box-body">
                        ...
                        <ContentTemplate>
                            <div align="center">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddl_plant" class="form-control" runat="server" Width="205px"
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddl_routes" runat="server" class="form-control">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width: 6px;">
                                        </td>
                                ...
                                <asp:Panel ID="hidePanel" runat="server" Visible="false">
                                    <div style="width: 100%;">
                                        ...
                                        <div style="width: 100%; padding-left: 18%;">
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Routewise Locations
                                                Report</span><br />
                                            <div>
                                            </div>
                                        </div>
