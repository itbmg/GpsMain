<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TempratureReport.aspx.cs" Inherits="TempratureReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <section class="content-header">
            <h1>
                Temperature Report<small>Preview</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Tools</a></li>
                <li><a href="#">Temperature Report</a></li>
            </ol>
        </section>
        <br />
        <section class="content">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <i style="padding-right: 5px;" class="fa fa-cog"></i>Temperature Report Details
                    </h3>
                </div>
                <div class="box-body">
                                ...
                                <asp:Panel ID="hidePanel" runat="server" Visible="false">
                                    <div style="width: 100%;">
                                        ...
                                        <div style="width: 100%; padding-left: 18%;">
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Temprature Report</span><br />
                                            <div>
                                            </div>
                                        </div>
                                        <div>
