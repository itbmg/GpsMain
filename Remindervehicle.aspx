<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Remindervehicle.aspx.cs" Inherits="Remindervehicle" %>
...
//            GetVehiclePopUp();
        ...
        function divOver(id) {
            ...
            //            document.getElementById(id).style.background = "rgba(192, 192, 192, 0.7)";
            ...
            $('#divmap').append(child);
            MultipleMapClick();
            //            document.getElementById(dd).style.height = "1000px";
            //            document.getElementById(dd).style.width = "1000px";
            //            document.getElementById(dd).style.zIndex = "99";
            //            document.getElementById(id).style.paddingLeft = "30%";
            //            document.getElementById(id).parentNode('div3').css('padding-left', '30%');
        }
    ...
    <script type="text/javascript">
        ...
        var listcontrols1 = [];
        function HomeControl1(Mapdiv1, map1, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText1.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlUI1.appendChild(controlText1);
            listcontrols1.push({ controlUI1: controlUI1 });
        }
        var listcontrols2 = [];
        function HomeControl2(Mapdiv2, map2, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText2.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlUI2.appendChild(controlText2);
            listcontrols2.push({ controlUI2: controlUI2 });
        }
        var listcontrols3 = [];
        function HomeControl3(Mapdiv3, map3, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText3.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlUI3.appendChild(controlText3);
            listcontrols3.push({ controlUI3: controlUI3 });
        }
        var listcontrols4 = [];
        function HomeControl4(Mapdiv4, map4, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText4.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText4.id = 'divmap4';
            controlUI4.appendChild(controlText4);
            listcontrols4.push({ controlUI4: controlUI4 });
        }
        function HomeControl5(Mapdiv5, map5, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText5.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText5.id = 'divmap5';
            controlUI5.appendChild(controlText5);
        }
        function HomeControl6(Mapdiv6, map6, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText6.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText6.id = 'divmap6';
            controlUI6.appendChild(controlText6);
        }
        function HomeControl7(Mapdiv7, map7, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText7.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText7.id = 'divmap7';
            controlUI7.appendChild(controlText7);
        }
        function HomeControl8(Mapdiv8, map8, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText8.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText8.id = 'divmap8';
            controlUI8.appendChild(controlText8);
        }
        function HomeControl9(Mapdiv9, map9, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText9.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText9.id = 'divmap9';
            controlUI9.appendChild(controlText9);
        }
        function HomeControl10(Mapdiv10, map10, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText10.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText10.id = 'divmap10';
            controlUI10.appendChild(controlText10);
        }
        function HomeControl11(Mapdiv11, map11, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText11.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText11.id = 'divmap11';
            controlUI11.appendChild(controlText11);
        }
        function HomeControl12(Mapdiv12, map12, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText12.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText12.id = 'divmap12';
            controlUI12.appendChild(controlText12);
        }
        function HomeControl13(Mapdiv13, map13, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText13.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText13.id = 'divmap13';
            controlUI13.appendChild(controlText13);
        }
        function HomeControl14(Mapdiv14, map14, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText14.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText14.id = 'divmap14';
            controlUI14.appendChild(controlText14);
        }
        function HomeControl15(Mapdiv15, map15, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText15.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText15.id = 'divmap15';
            controlUI15.appendChild(controlText15);
        }
        function HomeControl16(Mapdiv16, map16, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText16.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText16.id = 'divmap16';
            controlUI16.appendChild(controlText16);
        }
        function HomeControl17(Mapdiv17, map17, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText17.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText17.id = 'divmap17';
            controlUI17.appendChild(controlText17);
        }
        function HomeControl18(Mapdiv18, map18, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText18.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText18.id = 'divmap18';
            controlUI18.appendChild(controlText18);
        }
        function HomeControl19(Mapdiv19, map19, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText19.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
            controlText19.id = 'divmap19';
            controlUI19.appendChild(controlText19);
        }
        function HomeControl20(Mapdiv20, map20, vehicleno, RouteName, vehiclereading, odometer_time) {
            ...
            controlText20.innerHTML = '<b ><span style="font-size:16px;color:Green;">' + vehiclereading + "-" + '</span><b>' + vehicleno + "-" + '<span style="font-size:14px;color:Red;">' + odometer_time + '</span><b>';
    ...
    <script type="text/javascript">
//        var GetPopUpTime;
//        function GetVehiclePopUp() {
//            var countdown = 0;
//            countdown = 1 * 60 * 1000;
//            GetPopUpTime = setInterval(function () { Showtext() }, countdown);
//        }
//        function Showtext() {
...
//        }
        ...
        function BindUpdate(data, ServerDt) {
            ...
            if (isplantview) {
                ...
                for (var vehicledata in data) {
                    ...
                    var model = livedata[vehicledata].model;
                    var capacity = livedata[vehicledata].capacity;
                    var vehiclereading = livedata[vehicledata].vehiclereading;
                    var odometer_time = livedata[vehicledata].odometer_time;
                    if (mainpower == "ON") {
                        var mainpowericon = vehicle.closest('tr').find('#imgpower');
                        mainpowericon.attr("src", "LiveIcons/Green%20Power.png");
                        mainpowericon.attr('title', 'Power On');
                    ...
                    if (count > -1) {
                        ...
                        if (ViewType == "MultipleView") {
                            MultimapPlaceMarker(myCenter, iconsrc, vehicleno, make, model, capacity, speed, timestamp, count, DriverName, RouteName, MobileNo, stpdtimestamp, vehiclereading, odometer_time);
                        }
                        else {
    ...
    <script type="text/javascript">
            ...
            if (isplantview) {
                ...
                for (var vehicledata in livedata) {
                    ...
                    if (count > -1) {
                        ...
                        GetPopUpTime = setInterval(function () { addVehicleRemarks(Veh, latitude, longitude) }, countdown);
        ...
        function MultimapPlaceMarker(location, iconsrc, vehicleno, make, model, capacity, speed, timestamp, count, DriverName, RouteName, MobileNo, stpdtimestamp, vehiclereading, odometer_time) {
            var Username = '<%= Session["field1"] %>';
            var image = new google.maps.MarkerImage(iconsrc,
            // This marker is 20 pixels wide by 32 pixels tall.
        null,
        ...
        new google.maps.Point(20, 20)
            ...
            if (count % mapcount == 19) {
                ...
                var homeControlDiv20 = document.createElement('div');
                var homeControl20 = new HomeControl20(homeControlDiv20, map20, vehicleno, RouteName, vehiclereading, odometer_time);
                map20.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv20);
                mMap = map20;
            }
            if (count % mapcount == 18) {
                var homeControlDiv19 = document.createElement('div');
                var homeControl19 = new HomeControl19(homeControlDiv19, map19, vehicleno, RouteName, vehiclereading, odometer_time);
                map19.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv19);
                mMap = map19;
            }
            if (count % mapcount == 17) {
                var homeControlDiv18 = document.createElement('div');
                var homeControl18 = new HomeControl18(homeControlDiv18, map18, vehicleno, RouteName, vehiclereading, odometer_time);
                map18.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv18);
                mMap = map18;
            }
            if (count % mapcount == 16) {
                var homeControlDiv17 = document.createElement('div');
                var homeControl17 = new HomeControl17(homeControlDiv17, map17, vehicleno, RouteName, vehiclereading, odometer_time);
                map17.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv17);
                mMap = map17;
            }
            ...
            if (count % mapcount == 15) {
                var homeControlDiv16 = document.createElement('div');
                var homeControl16 = new HomeControl16(homeControlDiv16, map16, vehicleno, RouteName, vehiclereading, odometer_time);
                map16.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv16);
                mMap = map16;
            }
            if (count % mapcount == 14) {
                var homeControlDiv15 = document.createElement('div');
                var homeControl15 = new HomeControl15(homeControlDiv15, map15, vehicleno, RouteName, vehiclereading, odometer_time);
                map15.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv15);
                mMap = map15;
            }
            if (count % mapcount == 13) {
                var homeControlDiv14 = document.createElement('div');
                var homeControl14 = new HomeControl14(homeControlDiv14, map14, vehicleno, RouteName, vehiclereading, odometer_time);
                map14.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv14);
                mMap = map14;
            }
            ...
            if (count % mapcount == 12) {
                var homeControlDiv13 = document.createElement('div');
                var homeControl13 = new HomeControl13(homeControlDiv13, map13, vehicleno, RouteName, vehiclereading, odometer_time);
                map13.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv13);
                mMap = map13;
            }
            ...
            if (count % mapcount == 11) {
                var homeControlDiv12 = document.createElement('div');
                var homeControl12 = new HomeControl12(homeControlDiv12, map12, vehicleno, RouteName, vehiclereading, odometer_time);
                map12.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv12);
                mMap = map12;
            }
            if (count % mapcount == 10) {
                var homeControlDiv11 = document.createElement('div');
                var homeControl11 = new HomeControl11(homeControlDiv11, map11, vehicleno, RouteName, vehiclereading, odometer_time);
                map11.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv11);
                mMap = map11;
            }
            if (count % mapcount == 9) {
                var homeControlDiv10 = document.createElement('div');
                var homeControl10 = new HomeControl10(homeControlDiv10, map10, vehicleno, RouteName, vehiclereading, odometer_time);
                map10.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv10);
                mMap = map10;
            }
            if (count % mapcount == 8) {
                var homeControlDiv9 = document.createElement('div');
                var homeControl9 = new HomeControl9(homeControlDiv9, map9, vehicleno, RouteName, vehiclereading, odometer_time);
                map9.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv9);
                mMap = map9;
            }
            if (count % mapcount == 7) {
                var homeControlDiv8 = document.createElement('div');
                var homeControl8 = new HomeControl8(homeControlDiv8, map8, vehicleno, RouteName, vehiclereading, odometer_time);
                map8.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv8);
                mMap = map8;
            }
            else if (count % mapcount == 6) {
                var homeControlDiv7 = document.createElement('div');
                var homeControl7 = new HomeControl7(homeControlDiv7, map7, vehicleno, RouteName, vehiclereading, odometer_time);
                map7.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv7);
                mMap = map7;
            }
            else if (count % mapcount == 5) {
                var homeControlDiv6 = document.createElement('div');
                var homeControl6 = new HomeControl6(homeControlDiv6, map6, vehicleno, RouteName, vehiclereading, odometer_time);
                map6.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv6);
                mMap = map6;
            }
            else if (count % mapcount == 4) {
                var homeControlDiv5 = document.createElement('div');
                var homeControl5 = new HomeControl5(homeControlDiv5, map5, vehicleno, RouteName, vehiclereading, odometer_time);
                map5.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv5);
                mMap = map5;
            }
            if (count % mapcount == 3) {
                var homeControlDiv4 = document.createElement('div');
                var homeControl4 = new HomeControl4(homeControlDiv4, map4, vehicleno, RouteName, vehiclereading, odometer_time);
                map4.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv4);
                mMap = map4;
            }
            else if (count % mapcount == 2) {
                var homeControlDiv3 = document.createElement('div');
                var homeControl3 = new HomeControl3(homeControlDiv3, map3, vehicleno, RouteName, vehiclereading, odometer_time);
                map3.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv3);
                ...
                var homeControlDiv2 = document.createElement('div');
                var homeControl2 = new HomeControl2(homeControlDiv2, map2, vehicleno, RouteName, vehiclereading, odometer_time);
                map2.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv2);
                mMap = map2;
            }
            else if (count % mapcount == 0) {
                var homeControlDiv1 = document.createElement('div');
                var homeControl1 = new HomeControl1(homeControlDiv1, map1, vehicleno, RouteName, vehiclereading, odometer_time);
                map1.controls[google.maps.ControlPosition.TOP_RIGHT].push(homeControlDiv1);
                mMap = map1;
            }
                ...
                if (status == google.maps.GeocoderStatus.OK) {
                    if (results.length > 0) {
                        if (results[0]) {
                            ...
                            var content = "VehicleID : " + vehicleno + "<br/>" + "Vehicle Make : " + make + "<br/>" + "Model : " + model + "<br/>" + "Capacity : " + capacity + "<br/>" + "Address : " + address + "<br/>" + "Speed : " + speed + " KMPH" + "<br/>" + "Update Status : " + timestamp + "<br/>" + "Driver Name : " + DriverName + "<br/>" + "Route Name : " + RouteName + "<br/>" + "Mobile No : " + MobileNo + "<br/>" + "Stopped From : " + stpdtimestamp + "<br/><a onclick='addlocations(" + location.lat() + "," + location.lng() + ")'>Add to My Locations</a><br/><a onclick='addRemarks(" + vehicleno + "," + location.lat() + "," + location.lng() + ")'>Add Remarks</a><br/>";
                            var infowindow = new google.maps.InfoWindow({
                                content: content
                            });
                            ...
                            attachInfowindow(marker, location, "VehicleID : " + vehicleno + "<br/>" + "Vehicle Make : " + make + "<br/>" + "Model : " + model + "<br/>" + "Capacity : " + capacity + "<br/>" + "Address : " + address + "<br/>" + "Speed : " + speed + " KMPH" + "<br/>" + "Update Status : " + timestamp + "<br/>" + "Driver Name : " + DriverName + "<br/>" + "Route Name : " + RouteName + "<br/>" + "Mobile No : " + MobileNo + "<br/>" + "Stopped From : " + stpdtimestamp);
                        }
                        else {
                            address = "No results";

                            var content = "VehicleID : " + vehicleno + "<br/>" + "Vehicle Make : " + make + "<br/>" + "Model : " + model + "<br/>" + "Capacity : " + capacity + "<br/>" + "Address : " + address + "<br/>" + "Speed : " + speed + " KMPH" + "<br/>" + "Update Status : " + timestamp + "<br/>" + "Driver Name : " + DriverName + "<br/>" + "Route Name : " + RouteName + "<br/>" + "Mobile No : " + MobileNo + "<br/>" + "Stopped From : " + stpdtimestamp;
                            var infowindow = new google.maps.InfoWindow({
                                content: content
                            });
                ...
                if (status == google.maps.GeocoderStatus.OK) {
                    if (results.length > 0) {
                        if (results[0]) {
                            ...
                            attachInfowindow(marker, location, "VehicleID : " + vehicleno + "<br/>" + "Vehicle Make : " + make + "<br/>" + "Model : " + model + "<br/>" + "Capacity : " + capacity + "<br/>" + "Address : " + address + "<br/>" + "Speed : " + speed + " KMPH" + "<br/>" + "Update Status : " + timestamp + "<br/>" + "Driver Name : " + DriverName + "<br/>" + "Route Name : " + RouteName + "<br/>" + "Mobile No : " + MobileNoileNo + "<br/>" + "Stopped From : " + stpdtimestamp);
                        }
                    }
                    else {
                        address = "No results";
        ...
        function addVehicleRemarks(vehicleno, lat, long) {
            var now = new Date();
            now.format("dd/MM/yyyy h:mm tt");
            $("#divupdateinfo").css("display", "block");
            $("#txtvehno").val(vehicleno);
            $("#txttime").val(now);
            $("#txtlat").val(lat);
            $("#txtlong").val(long);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="width: 100%; height: 100%;">
        ...
        <br />
        <br />
        <div style="height: 30px; top: 46px; position: absolute; z-index: 99999;">
            <%-- <a onclick="SingleMapClick();" style="color:White;margin-right:30px;text-decoration:none;"><b>Single Map</b></a> --%>
        ...
        <br />
        <div style="width: 100%;">
            <div id="divmaptypes" style="display: block; right: 10px; height: 30px; top: 68px;
                position: absolute; z-index: 99999;">
                 <a onclick="MapviewClick();" style="color:Black; margin-left: 10px; margin-right: 20px;
                text-decoration: none;"><b>Map View</b></a> <a onclick="TripviewClick();" style="color: Black;
                    text-decoration: none; margin-right: 2px;"><b>Trip View </b></a>
            <input type="checkbox" id="ckb_plantview" onclick="PlantviewClick();" /><b style="color: Black;
                margin-right: 10px;">Plant View </b>
                <span>MapType</span>
        ...
        <div class="togglediv" id="divtoggle">
            <div class="inner">
                ...
                <table cellpadding="0" cellspacing="0" style="background-color: #627d9a;">
                    <tr style="background: none 0px 0px repeat scroll rgba(0, 0, 0, 0.0980392);border-width: medium;border-style: none;border-color: initial;color: rgb(250, 251, 251);background-color: #2f4e6d;">
                        <td>
                        </td>
                        <td>
                           <cc1:DropDownCheckList ID="chblZones" runat="server" BorderColor="black" BorderStyle="Solid"
                                ...
                                DisplayBoxCssStyle="cursor: pointer; width:170px; height:30px;z-index:99999;border-bottom: medium none;border-top: medium none;border-left: medium none;border-right: medium none;color: #FFFFFF; background: none repeat scroll 0 0 rgba(0, 0, 0, 0.1);border-radius: 49px;"
                        ...
                        <td>
                            <div style="display: block; width: 160px;" id="divchblvehicles">
                                 <cc1:DropDownCheckList ID="chblVehicleTypes" runat="server" BorderColor="black" BorderStyle="Solid"
                                    AutoPostBack="true" ForeColor="#979797" Style="color: black;font-weight: bold;" CheckListCssStyle="position:absolute;z-index:99999;overflow: auto; border: 1px solid black; padding: 4px; max-height:300px; background-color: #ffffff;"
                                    DisplayBoxCssStyle="cursor: pointer; width:160px; height:30px;z-index:99999; border-bottom: medium none;border-top: medium none;border-left: medium none;border-right: medium none;color: #FFFFFF; background: none repeat scroll 0 0 rgba(0, 0, 0, 0.1); border-radius: 49px; text-align: center;"
                    ...
                    <tr style="background: none 0px 0px repeat scroll rgba(0, 0, 0, 0.0980392);border-width: medium;border-style: none;border-color: initial;color: rgb(250, 251, 251);background-color: #2f4e6d;">
                        ...
                        <td colspan="2">
                            <div style="display: block; width: 310px;" id="divchblstatus">
                ...
                <div id="divvehicles" style="width: 330px; overflow-x: auto; height: 90%;background-color: #2f496c;">
                    <div id="divAllvehicles" style="background: none repeat scroll 0 0 rgba(0, 0, 0, 0.1);border-bottom: medium none;border-top: medium none;border-left: medium none;border-right: medium none;color: #fafbfb;">
                    </div>
                </div>
            </div>
        </div>
