<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TripAssignedVehicleList.aspx.cs" Inherits="TripAssignedVehicleList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
  <script src="js/JTemplate.js?v=1502" type="text/javascript"></script>
    ...
    <link href="http://49.50.65.160/HRMSapp/CSS/jquery-ui-1.10.3.custom.css?v=1502" rel="stylesheet" type="text/css" />
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCNJQwYwI1XH2nQzqszGuv5WKpkjNzY-Z8&v=3.exp&libraries=geometry&sensor=false"></script>
...
//                            var Rname = vehicle.closest('tr').find("#ks");
//                            Rname = "KALISHENBA";
        ...
        <div class="togglediv" id="divtoggle">
            <div class="inner">
                ...
                <div id="divvehicles" style="width: 330px; overflow-x: auto; height: 90%;">
                    <div id="divAllvehiclesassign" style="border-bottom: medium none;border-top: medium none;border-left: medium none;border-right: medium none;color: black;">
                    </div>
                </div>
            </div>
        </div>
